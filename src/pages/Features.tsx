      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center animate-fade-in">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 gradient-text">Why You'll Love Fabel</h1>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => <Card key={index} className="group relative overflow-hidden border-2 hover:border-fabel-primary/50 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 animate-fade-in" style={{
      ...
      <section className="py-20 gradient-fabel">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90 leading-relaxed animate-fade-in" style={{
            animationDelay: "100ms"
          }}>
              Let Fabel handle the strategy while you focus on creativity.
            </p>
            
            <Button asChild size="lg" className="bg-white text-fabel-primary hover:bg-white/90 px-8 py-4 text-lg rounded-xl transition-all duration-300 hover:scale-105 shadow-lg animate-fade-in" style={{

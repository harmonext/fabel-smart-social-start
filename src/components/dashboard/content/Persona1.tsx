            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex justify-center gap-8 mb-6">
                  ...
                  <div className="text-center">
                    <div className="w-12 h-12 bg-black rounded-lg flex items-center justify-center text-white text-xl font-bold mb-2">
                      <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current">
                        <path d="M12.5 2.5a10 10 0 1 0 10 10 10.01 10.01 0 0 0-10-10Zm5.55 8.1a2.65 2.65 0 0 1-1 .36 1.75 1.75 0 0 0 .78-1 3.51 3.51 0 0 1-1.11.42 1.75 1.75 0 0 0-3 1.59 5 5 0 0 1-3.57-1.81 1.75 1.75 0 0 0 .54 2.33 1.73 1.73 0 0 1-.79-.22v.02a1.75 1.75 0 0 0 1.4 1.71 1.8 1.8 0 0 1-.79 0 1.75 1.75 0 0 0 1.63 1.21 3.5 3.5 0 0 1-2.58.72 5 5 0 0 0 2.68.78c3.22 0 5-2.67 5-5v-.23a3.57 3.57 0 0 0 .88-.9Z"/>
                      </svg>
                    </div>
                    <Checkbox />
                  </div>

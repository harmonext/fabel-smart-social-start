...
const MarketingOnboardingForm = () => {
  ...
  const validateCurrentTab = (): boolean => {
    switch (activeTab) {
      ...
      case "about-customer":
        return formData.customer_gender.length > 0 && formData.customer_age_ranges.length > 0 && formData.customer_income_ranges.length > 0;
      default:
        return false;
    }
  };
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center space-x-4">
            {tabs.map((tab, index) => <div key={tab.id} className="flex items-center">
                <div className="flex flex-col items-center">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${index <= getCurrentTabIndex() ? 'text-white' : 'text-gray-600'}`} style={{
                ...
                {index < tabs.length - 1 && <div className={`w-16 h-0.5 mx-2`} style={{
        ...
        borderColor: '#abbdc6'
          ...
          <CardContent className="p-8">
            ...
            {/* Navigation Buttons */}
            <div className="flex justify-between mt-8 pt-6 border-t" style={{
            borderColor: '#abbdc6'
          }}>
              ...
              {canGoNext && <Button onClick={handleNext} disabled={!isCurrentTabValid} className="px-6 py-2 text-white border-0" style={{
